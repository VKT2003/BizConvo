    ...
    <>
      {Object.keys(chatPerson).length > 0 ? (
          ...
          <div className={`${styles.footer}`}>
            <form onSubmit={handleSendMessage}>
              ...
              <div className={`${styles.input}`}>
                ...
                <span>
                  <label htmlFor="file"><i className={`${styles.attach} fa-solid fa-paperclip`}></i></label>
                </span>
                <div className={`${styles.footerIcons}`}>
                  <i className={`${styles.mic} fa-solid fa-microphone`}></i>
                  <div className={`${styles.sep}`}></div>
                  <i className={`${styles.send} fa-solid fa-paper-plane`} onClick={handleSendMessage}></i>
                </div>
              </div>
            </form>
          </div>
        ...
        <div className={`${styles.chatImage}`} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
          <img src="/emptyChat.webp" width={100} height={100} style={{ width: '250px', height: '250px' }} loading='lazy' alt="cloud" />
