...
const NewChatModel = () => {
    ...
    const { handleOpenChat } = useOpenContext();
            ...
            <div className={`${styles.header}`}>
                <div className={`${styles.top}`}>
                    ...
                    <div className={`${styles.right}`}>
                        <img src="/close.webp" alt="close" onClick={toggleNewChatModal} />
                    </div>
                </div>
                <form className={`${styles.bottom}`}>
                    <div className={`${styles.input}`}>
                        ...
                        <span><label htmlFor="search"><img src="/search.webp" alt="search" /></label></span>
                    </div>
                </form>
            </div>
            <div className={`${styles.body}`}>
                {filteredReceivers.map((u) => (
                    <div className={`${styles.chats}`} key={u._id} onClick={() => {
                        handleAddChat(u)();
                        handleChatPerson(u)();
                        handleOpenChat();
                    }}>
                        <div className={`${styles.profile}`}>
                            <img src={u.picture || "/anonymous.webp"} alt="profile" />
